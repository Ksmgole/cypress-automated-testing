...
var indonesianTfcUrl = VerisignHelper.getIndonesianTfcUrl(),
    indonesianTfcPricingPageUrl = VerisignHelper.getIndonesianTfcPricingPageUrl(),
    indianTfcUrl = VerisignHelper.getIndianTfcUrl(),
    indianTfcPricingPageUrl = VerisignHelper.getIndianTfcPricingPageUrl(),
...
describe('Verisign Campaign Test flow 3 for Indonesia',()=>{
    it('should have Promotional Sticker',() => {
        cy.visit(indonesianTfcUrl)        
    ...
    it('should have 5 Days Trial in pricing page',() => {
        cy.visit(indonesianTfcPricingPageUrl)
...
describe('Verisign Campaign Test flow 3 for India',()=>{
    it('should have Promotional Sticker',() => {
        cy.visit(indianTfcUrl)        
    ...
    it('should have 5 Days Trial in pricing page',() => {
        cy.visit(indianTfcPricingPageUrl)
        cy.get('.pv-section h1.pv-title').contains(verisignTrial)
    })
    it('should have promotional 73% discount sticker in pricing box(index page)',() => {
        cy.visit(indianTfcUrl)        
